...
class Emp05078{
    ...
    public Emp05078(String a, String b) {
    ...
    public String toString(){
        ...
        return String.format("%s %s %d", empID, empName, total);
...
public class J05078 {
    ...
    public static void main(String arg[]){
        ...
        Vector<Emp05078> v = new Vector<>();
        Vector<Emp05078> vx = new Vector<>();
        while(t-->0){

            v.add(new Emp05078(sc.next(),sc.nextLine().trim()));
        ...
        while(t-->0){
            ...
            for(Emp05078 x:v){
                ...
                if(x.id.equals(id.substring(3))){
                    ...
                    Emp05078 tmp = new Emp05078(x.id,x.name);
        ...
        for(Emp05078 x:v){
            ...
            if(x.id.equals(q)){
                ...
                System.out.println(String.format("Bang luong phong %s:", x.name));
                break;
